...
ctx.keymap(
    {
        ...
        "(undo that | dizzle)": Key("cmd-z"),
        "(redo that | rizzle)": Key("cmd-shift-z"),
        # clipboard
        ...
        "((select | sell) this word)": Key("alt-right shift-alt-left"),
        ...
        "((select | sell) left | shrim)": Key("shift-left"),
        "((select | sell) right | shrish)": Key("shift-right"),
        ...
        "((select | sell) word right | skittish)": Key("alt-shift-right"),
